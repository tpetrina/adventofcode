...
export function Layout({ children, meta: pageMeta }) {
  ...
  return (
    <>
          ...
          <ul className="flex justify-between items-center space-x-4">
            ...
            <li>
              <a
                ...
                href="https://github.com/tpetrina/adventofcode"
      ...
      <hr />
      <section className="flex justify-between items-center p-8 mx-2">
        <p>
          Forked from{' '}
          <a href="https://github.com/leerob/nextjs-prism-markdown">
